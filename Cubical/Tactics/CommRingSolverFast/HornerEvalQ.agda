module Cubical.Tactics.CommRingSolverFast.HornerEvalQ where

open import Cubical.Foundations.Prelude

open import Cubical.Data.Nat using (ℕ)
open import Cubical.Data.Rationals.Fast hiding (_+_ ; _·_ ; -_;+IdR;+IdL)
...
eval : {A : RawAlgebra ℚAsRawRing ℓ'}
...
-- module HRE (R : CommRing ℓ) (homFromℤ@(scalar , _) : CommRingHom ℚCommRing R) where
--   private
