...
path≡Id = isoToPath (pathToId , record { inverse = idToPath ; rightInv = idToPathToId ; leftInv = pathToIdToPath })
...
equivPath≡Equiv {ℓ} = isoToPath (equivPathToEquiv {ℓ} , record { inverse = equivToEquivPath ; rightInv = equivToEquiv ; leftInv = equivPathToEquivPath })
