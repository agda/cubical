...
-}
{-# OPTIONS --safe #-}
module Cubical.Algebra.CommAlgebra.AsModule.FPAlgebra.Instances where
...
open import Cubical.Algebra.CommAlgebra.AsModule.Ideal using (IdealsIn)
...
open import Cubical.Algebra.CommAlgebra.AsModule.FPAlgebra.Base
