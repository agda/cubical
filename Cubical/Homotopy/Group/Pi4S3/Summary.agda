...
-- Ideally one could prove the β is 2 by normalization, but this does
-- not seem to terminate before we run out of memory. So instead we
-- prove this by hand as in the second half of Guillaume's thesis.
β≡2 : β ≡ 2
β≡2 = Brunerie≡2
...
-- And that π₃(S²) is generated by the Hopf map.
...
π₄S³≃ℤ/2ℤ = subst (λ X → GroupEquiv (π 4 𝕊³) X) (cong ℤ/_ β≡2) βSpec
