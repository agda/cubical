...
module _ {ℓ : Level} (A B C D : Pointed ℓ) where
  ...
  gluel≡gluer₁ : (y : typ B) (i j r k : I) → smot A B C
  ...
  gluem≡gluer₁ : (y : typ C) (i j r k : I) → smot A B C
  ...
  gluel≡gluer₂ : (y : typ B) (k i j r : I) → smot A B C
  ...
  gluem≡gluer₂ : (y : typ C) (k i j r : I) → smot A B C
  ...
  gluel≡gluem-fill : (a : typ A) → (i j k r : I) → smot A B C
  ...
  Iso₁ : Iso (Smash' A (Smash' B C , base)) (smot A B C)
  Iso.fun Iso₁ = sm→smot
  Iso.inv Iso₁ = smot→sm
