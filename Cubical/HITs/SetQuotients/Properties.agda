...
open import Cubical.Data.Sigma hiding (_Σ≡_)
...
-- raiseHLevel zero hA = isContr→isProp hA
...
hLevel≃ (suc n) hA hB = hLevelSigma (suc n) (hLevelPi (suc n) (λ _ → hB)) (λ a → subst (λ n → isOfHLevel n (isEquiv a)) (+-comm n 1) (hLevelLift n (isPropIsEquiv a)))
