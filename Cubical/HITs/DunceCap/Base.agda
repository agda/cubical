...
-- we show that DunceCone ≡ Dunce by way of two intermediate types Dunce₁ and Dunce₂

module DunceCone≡ where
...
open DunceCone≡ using (DunceCone-iso-Dunce; DunceCone≡Dunce)
