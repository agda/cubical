...
discreteDec Adis (yes p) (no ¬p) = Empty.rec (¬p p)
discreteDec Adis (no ¬p) (yes p) = Empty.rec (¬p p)
...
isPropDec Aprop (yes a) (no ¬a) = Empty.rec (¬a a)
isPropDec Aprop (no ¬a) (yes a) = Empty.rec (¬a a)
