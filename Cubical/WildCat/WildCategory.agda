...
-}
{-# OPTIONS --safe #-}
module Cubical.WildCategories.WildCategory where
...
record PrecatIso (C : WildCat ℓ ℓ') (x y : C .ob) : Type ℓ' where
...
module _ {ℓC ℓC' ℓD ℓD' : Level} where
 ...
 -- Functors
 record Prefunctor (C : WildCat ℓC ℓC') (D : WildCat ℓD ℓD') :
 ...
 record PreNatTrans (C : WildCat ℓC ℓC') (D : WildCat ℓD ℓD')
          (F G : Prefunctor C D) :
          Type (ℓ-max (ℓ-max ℓC ℓC') (ℓ-max ℓD ℓD')) where
   no-eta-equality
 ...
 -- Natural isomorphisms
 record PreNatIso (C : WildCat ℓC ℓC') (D : WildCat ℓD ℓD')
          (F G : Prefunctor C D) :
          Type (ℓ-max (ℓ-max ℓC ℓC') (ℓ-max ℓD ℓD')) where
   open PreNatTrans
