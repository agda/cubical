      ...
      where
        ...
        abstract
          q = f h α h'
              ...
              ((h' +ᴴ ((-₀ (f h')) α h))) +ᴴ (-ᴴ h)
                ≡⟨ {!!} ⟩
              ((h' +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h)))) +ᴴ (-ᴴ h)
                ≡⟨ cong (_+ᴴ (-ᴴ h)) (sym (rIdᴴ ((h' +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h)))))) ⟩
              ((h' +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h)
                ≡⟨ cong (λ z → ((z +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h))
                        (sym (α-id h')) ⟩
              (((0₀ α h') +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h)
                ≡⟨ cong (λ z → ((((0₀ α z)) +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h))
                        (sym (rIdᴴ h')) ⟩
              ((((0₀ α (h' +ᴴ 0ᴴ))) +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h)
                ≡⟨ cong (λ z → ((((0₀ α (h' +ᴴ z))) +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h))
                        (sym (actOnUnit A 0₀)) ⟩
              ((((0₀ α (h' +ᴴ (0₀ α 0ᴴ)))) +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h)
                ≡⟨ cong (λ z → ((((0₀ α (h' +ᴴ (0₀ α z)))) +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h))
                        (sym (actOn-Unit A ((-₀ ((f h') +₀ 0₀))))) ⟩
              ((((0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h)
                ≡⟨ cong (λ z → ((z +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h) )
                        (sym (lIdᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ))))))) ⟩
              (((0ᴴ +ᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ ((-₀ (f h')) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h)
                ≡⟨  cong (λ z → (((0ᴴ +ᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ (z α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h))
                        (sym (lId-lId G₀ (-₀ (f h')))) ⟩
              (((0ᴴ +ᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ ((0₀ +₀ (0₀ +₀ (-₀ (f h')))) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h)
                ≡⟨ cong (λ z → (((0ᴴ +ᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ ((0₀ +₀ (0₀ +₀ (-₀ z))) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h))
                        (sym (rId₀ (f h'))) ⟩
              (((0ᴴ +ᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ ((0₀ +₀ (0₀ +₀ (-₀ ((f h') +₀ 0₀)))) α ((-₀ 0₀) α h))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h)
                ≡⟨ cong (λ z → (((0ᴴ +ᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ ((0₀ +₀ (0₀ +₀ (-₀ ((f h') +₀ 0₀)))) α z)) +ᴴ 0ᴴ) +ᴴ (-ᴴ h))
                        (sym (lIdᴴ ((-₀ 0₀) α h))) ⟩
              (((0ᴴ +ᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ ((0₀ +₀ (0₀ +₀ (-₀ ((f h') +₀ 0₀)))) α (0ᴴ +ᴴ ((-₀ 0₀) α h)))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h)
                ≡⟨ cong (λ z → (((0ᴴ +ᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ ((0₀ +₀ (0₀ +₀ (-₀ ((f h') +₀ 0₀)))) α (z +ᴴ ((-₀ 0₀) α h)))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h))
                        (sym (actOn-Unit A (-₀ 0₀))) ⟩
              (((0ᴴ +ᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ ((0₀ +₀ (0₀ +₀ (-₀ ((f h') +₀ 0₀)))) α (((-₀ 0₀) α (-ᴴ 0ᴴ)) +ᴴ ((-₀ 0₀) α h)))) +ᴴ 0ᴴ) +ᴴ (-ᴴ h)
                ≡⟨ cong (λ z → (((0ᴴ +ᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ ((0₀ +₀ (0₀ +₀ (-₀ ((f h') +₀ 0₀)))) α (((-₀ 0₀) α (-ᴴ 0ᴴ)) +ᴴ ((-₀ 0₀) α h)))) +ᴴ z) +ᴴ (-ᴴ h))
                        (sym (actOnUnit A (((0₀ +₀ (0₀ +₀ (-₀ ((f h') +₀ 0₀)))) +₀ ((-₀ 0₀) +₀ 0₀))))) ⟩
              (((0ᴴ +ᴴ (0₀ α (h' +ᴴ (0₀ α ((-₀ ((f h') +₀ 0₀)) α (-ᴴ 0ᴴ)))))) +ᴴ ((0₀ +₀ (0₀ +₀ (-₀ ((f h') +₀ 0₀)))) α (((-₀ 0₀) α (-ᴴ 0ᴴ)) +ᴴ ((-₀ 0₀) α h)))) +ᴴ (((0₀ +₀ (0₀ +₀ (-₀ ((f h') +₀ 0₀)))) +₀ ((-₀ 0₀) +₀ 0₀)) α 0ᴴ)) +ᴴ (-ᴴ h)
                ≡⟨ refl ⟩
              fst (((is (h , 0₀) +₁ ((h' , 0₀) +₁ -it (h' , 0₀))) +₁ (-is (h , 0₀) +₁ (h , 0₀))) +₁ (0ᴴ , 0₀)) +ᴴ (-ᴴ h)
                ≡⟨ cong (_+ᴴ (-ᴴ h))
                        (cong fst
                              (♭isPeif (h' , 0₀) (h , 0₀))) ⟩
              (h +ᴴ (0₀ α h')) +ᴴ (-ᴴ h)
                ≡⟨ cong (λ z → (h +ᴴ z) +ᴴ (-ᴴ h))
                        (IsGroupAction.identity isAct h') ⟩
              (h +ᴴ h') +ᴴ (-ᴴ h) ∎
