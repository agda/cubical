...
Iso.leftInv test13 a =
  ...
  test j i =
    ...
    helper =
      ...
      (λ j → cong (a north +ₖ_) (sym (rCancelₖ (a north))) ∙ cong₂Funct2 (λ x y → a north +ₖ a x +ₖ (-ₖ (a y))) (merid south) (merid north) j ∙ cong (a north +ₖ_) ((rCancelₖ (a south)))) ∙
      ...
      (invGrIso
        (SES→Iso
          ...
          (ses (isOfHLevelProd 1 (isOfHLevelSuc 0 (isContrCohomUnit 0)) (isOfHLevelSuc 0 (isContrCohomUnit 0)))
               ...
               (Δ-morph _ _ (S₊ 0) (λ _ → tt) (λ _ → tt) 1)
               (i-morph _ _ (S₊ 0) (λ _ → tt) (λ _ → tt) 2)
               (d-morph _ _ (S₊ 0) (λ _ → tt) (λ _ → tt) 1)
