...
module Cubical.ZCohomology.MayerVietorisUnreduced2 where
...
morph.fun (Δ {f = f} {g = g} n) (α , β) = coHomFun n f α +ₕ -ₕ (coHomFun n g β)
morph.ismorph (Δ {f = f} {g = g} zero) =
