...
ℓ-desc ℓ (rec d) = ℓ-max ℓ (ℓ-desc ℓ d)
...
macro-structure (rec d) X = X → macro-structure d X
...
macro-iso (rec d) = unaryFunIso (macro-iso d)
...
macro-is-SNS (rec d) = unaryFunSNS (macro-iso d) (macro-is-SNS d)
