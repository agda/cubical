...
relMacro-structure (param A d) = param-setStructure A (λ _ → relMacro-structure d)
...
relMacro-rel (param A d) = param-propRel A (λ _ → relMacro-rel d)
...
isSNRSRelMacro (param A d) = isSNRSParam A (λ _ → isSNRSRelMacro d)
