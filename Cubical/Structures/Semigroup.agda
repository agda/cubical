...
module SemigroupΣ-theory {ℓ} where
  ...
  raw-semigroup-is-SNS : UnivalentStr _ raw-semigroup-iso
  ...
  semigroup-structure = AxiomStructure raw-semigroup-structure semigroup-axioms
  ...
  semigroup-iso = AxiomEquivStr raw-semigroup-iso semigroup-axioms
